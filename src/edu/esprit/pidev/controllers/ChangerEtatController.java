 ...
 * @author DIARRA
 */
public class ChangerEtatController implements Initializable {
   ...
   /* @Override
    ...
    private void recuperer(ActionEvent event) {
        Reclamation selectedEvent=(Reclamation) tableV.getSelectionModel().getSelectedItem();
    ...
    @FXML
    private void rechercherTout(ActionEvent event) {
        ReclamationService boutService = new ReclamationService();
           
          
          String srch = txtRecherche.getText();
          
         
        tableV.setItems(boutService.rechercher(srch));
         System.out.println("okkkkkkkkk");
    }

    @FXML
    private void modifierTout(ActionEvent event) throws IOException {
